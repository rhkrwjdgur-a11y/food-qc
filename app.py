        ...
        if st.button("▶️ 기타면/측면 분석 시작", key="btn_extra"):
            with st.spinner("【의무표시 및 인증마크 해독 중...】"):
                missions = [
                    ...
                    "⭐ [유연 스캔 명령]: 패키지 디자인의 유동성 때문에 '용기 세부 재질', '보관방법/주의사항' 등이 다른 면(정보표시면 등)에 적혀 있을 수 있습니다. 현재 스캔된 이미지에 해당 내용이 보이지 않는다면 억지로 찾거나 부적합 처리하지 말고, '현재 이미지에는 없으나 다른 면 표기 확인 요망' 이라며 ⚠️(확인 요망) 처리하십시오."
                ]
