...
**Rule 19. 🌟 ['무가당/설탕 무첨가' 5대 무관용 원칙 (식약처 고시 완벽 동기화)]**
   ...
   - 🌟 [비당류 감미료 절대 예외 허용]: 단, 식약처 고시에 따라 당류에 해당하지 않는 식품첨가물(알룰로스, 에리스리톨, 수크랄로스 등) 단독 사용은 예외로 두어 무가당 표시를 합법(✅) 처리하십시오. (단, 이런 감미료를 썼더라도 부형제로 덱스트린이 섞여 있다면 불법입니다.)
