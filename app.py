...
🔥 **Rule 70. [내/외포장 원재료명 100% 일치 강제 스나이퍼 룰 (V171.0 신설)]**
...
# 💡 [V171.0 패치] Rule 70(내외포장 일치) 탭 2 배정
...
def main():
    ...
    st.title("🏭 식품 표시사항 정밀 검토 시스템 (V171.0 - 내/외포장 스나이퍼 탑재)")
