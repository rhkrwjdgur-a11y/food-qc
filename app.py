...
def main():
    ...
    st.title("🏭 식품 표시사항 정밀 검토 시스템 (V156.7 - 시안 대조 초정밀 타겟팅 완결판)")
    ...
    def run_qc_3pass(tab_rules: str, judgment_prompt: str):
        ...
        # ── PASS 1: 순수 텍스트 추출 및 증빙 서류 마스터링 (배열 강제 고정 패치) ──
        pass1_prompt = """
...
- ⭐ [Rule 60 범용 적용] 제품명에 강조된 '타겟 원료'가 '페이스트, 농축액...' 형태일 때 괄호 안에 타겟 원물의 함량(%)이 있는지 강제 강제. (주의: 강조되지 않은 조연 원물의 함량 생략은 합법이므로 역산/지적 절대 금지):
