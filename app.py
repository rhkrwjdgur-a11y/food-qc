...
**Rule 20. [포장재질 및 종이팩(카톤팩) 분리 표시 룰 (종이 텍스트 기재 금지)]**
- 환경부 규정에 따른 분리배출 도안에는 '종이팩'으로 표기하되, 식약처 용기·포장재질(텍스트) 표기 의무는 식품과 직접 접촉하는 '합성수지제 및 고무제'에만 발생합니다.
- 🛑 [종이 기재 전면 금지]: 종이나 유리는 규정 목록에 없으며 접촉면도 아니므로, 텍스트로 '종이'라고 적는 순간 과잉/오기재 위반(🚨부적합)입니다. (예: '포장재질: 종이, 폴리에틸렌' -> 🚨부적합 / '포장재질: 폴리에틸렌(내면)' -> ✅적합)
...
# 탭별 맞춤형 룰 타겟팅
# ==========================================
TAB1_RULES = [3, 9, 17, 18, 19, 21, 24, 46, 50, 52, 53, 57, 62, 63, 66, 68, 71, 72, 84, 86, 87, 88, 94, 95, 96, 99, 100, 103, 105]
