...
# ==========================================
# 📚 3. 70대 룰북 원문 (V188.0 종이 분리배출 예외 반영)
# ==========================================
RULE_BOOK_FULL = """
...
🔥 **Rule 20. [포장재질 표시 (식약처 vs 환경부 분리 스나이퍼) (V188.0 패치)]**
...
def main():
    ...
    st.title("🏭 식품 표시사항 정밀 검토 시스템 (V188.0 - 환경부 종이 예외 완결판)")
...
| 타겟(박스) 시안 표기 원재료명 (순서대로) | 매칭된 마스터 서류 원료명 | 원산지 산정 순위 | 대조 검증 (오탈자/순서/합법 간략화) | 판정 (상세 사유) |
|---|---|---|---|---|
...
| 시안 표기 원재료명 (패키지 나열 순서) | 매칭된 마스터 서류 원료명 | 원산지 산정 순위 | 대조 검증 (오탈자/순서/합법 간략화) | 판정 (상세 사유) |
|---|---|---|---|---|
| (시안 기준 100% 나열) | (서류 원료명) | (도출 사유) | (검증 결과) | (✅/🚨 판정 및 사유) |
...
| 타겟(박스) 시안 표기 원재료명 (순서대로) | 매칭된 위 마스터 표 원료명 | 원산지 산정 순위 | 대조 검증 (오탈자/순서/합법 간략화) | 판정 (상세 사유) |
|---|---|---|---|---|
| (시안 기준 100% 나열) | (서류 원료명) | (도출 사유) | (검증 결과) | (✅/🚨 판정 및 사유) |
...
## 2️⃣ [원재료명 정밀 교차 검증 (시안 기준 대조 + 누락 적발)]
| 시안 표기 원재료명 (패키지 나열 순서대로) | 매칭된 위 마스터 표 원료명 | 원산지 산정 순위 | 대조 검증 (오탈자/순서/합법 간략화) | 판정 (상세 사유) |
|---|---|---|---|---|
| (시안 기준 100% 나열) | (서류 원료명) | (도출 사유) | (검증 결과) | (✅/🚨 판정 및 사유) |
