...
**Rule 24. [무당/무가당 강조표시 연계 의무: 열량 및 감미료 병기 (식약처 고시 완벽 반영)]**
   - [감미료/당알코올 표기]: '무당', '무가당', '당 ZERO' 강조 시, 원재료에 감미료가 쓰였다면 해당 강조표시 주위(인접한 둘레)에 **'감미료 함유'**를 표기해야 하며, 당알코올이 쓰였다면 **'당알코올 함유'**로 표기해도 합법(✅)입니다. 
...
def main():
    ...
    st.markdown("<h1>Label Guard AI <span style='font-size:0.5em; color:#64748b;'>식품 패키지 무결점 검증 시스템 (V5.9.3 Ultimate)</span></h1>", unsafe_allow_html=True)
