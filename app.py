...
🔥 **Rule 13. [알레르기 정밀 추적 및 파생 원료 예외 허용]**
   ...
   - **[⭐ 기계적 대조 예외]**: 파생 원료가 존재다면 절대 불일치로 오판하지 말고 무조건 적합(✅) 처리하십시오.
...
def main():
    ...
    st.title("🏭 식품 표시사항 정밀 검토 시스템 (V210.0 - 탭별 구역 분할 및 배합비 2% 스나이퍼)")
...
3. ⭐ [미션 B/C 표 검증]: 미션 B와 C의 결과물이 존재한다면 반드시 표(Table) 형태인지 확인하십시오.
