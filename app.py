...
🔥 **Rule 28. [복합원재료 원산지 독립성 확인]**
   - 시안에 알레르기 유발물질(땅콩, 호두 등)이 표시되어 있더라도, 해당 원료가 배합비 상위 3순위에 해당한다면 반드시 원산지 국가명을 병기하도록 지적할 것. "알레르기 표시를 했으므로 원산지 표시가 면제된다"는 논리는 법적 근거가 없음을 명시할 것.

🔥 **Rule 29. [국내 제조 가공품 원산지 정밀 표기]**
   - 국내에서 제조된 가공품(예: 미강유)을 원료로 사용할 경우, 국민신문고 가이드라인에 따라 기원 원료와 원산지를 명확히 매칭하여 **`현미유(미강유:태국산)`** 형태로 표기하여 원료 정체성 오인을 원천 차단할 것.

🔥 **Rule 30. [지정 알레르기 10종 특별 스캔 및 교차 검증]**
   - AI는 사용자가 지정한 10대 알레르기 유발물질(**대두, 땅콩, 알류, 밀, 복숭아, 토마토, 호두, 메밀, 아황산류, 잣**)을 목표로 설정합니다.
