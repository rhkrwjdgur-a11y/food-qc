...
# ==========================================
# 📚 3. 63대 룰북 원문 (V151.0 완결판 - Rule 63 미드팩 질소충전 룰 추가)
# ==========================================
RULE_BOOK_FULL = """
...
def main():
    ...
    st.title("🏭 식품 표시사항 정밀 검토 시스템 (V151.0 - 미드팩 질소충전 검증 패치)")
