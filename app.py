...
✅ **Rule 8. 수입 원료 원산지 유연성 보호**
   - 대두, 옥수수 등 수입 원료의 원산지 표기가 **"외국산(미국, 캐나다, 러시아 등)"**으로 되어 있다면 이는 [매 창우 적합]한 표기입니다.
...
def main():
    ...
    uploaded_files = st.file_uploader("파일 업로드 (시안, 시험성적서, 배합비 등)", type=["jpg", "png", "jpeg", "pdf"], accept_multiple_files=True)
