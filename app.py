...
# ==========================================
# 📚 3. 59대 룰북 원문 (V145.0 완결판 - Rule 59 CS/1399 누락 스캔 추가)
# ==========================================
RULE_BOOK_FULL = """
...
RULES_TAB1 = "[탭1 주표시면 관련 핵심 룰]\n" + get_sliced_rules([3, 9, 10, 15, 16, 17, 18, 19, 21, 24, 28, 40, 46, 47, 50, 51, 52, 53, 57, 58, 59] + COMMON_RULES)
RULES_TAB2 = "[탭2 정보표시면/원재료명 관련 핵심 룰]\n" + get_sliced_rules([1, 2, 5, 6, 8, 12, 13, 14, 25, 28, 29, 30, 34, 35, 38, 39, 44, 48, 49, 52, 54, 57, 58, 59] + COMMON_RULES)
...
def main():
    ...
    st.title("🏭 식품 표시사항 정밀 검토 시스템 (V145.0 - CS 및 1399 신고 의무표시 강제 스캔 패치)")
...
"""
    ...
    with tab4:
        if st.button("▶️ 기타면/측면 분석 시작", key="btn_extra"):
            with st.spinner("【3-Pass】 분석 진행 중..."):
                # 🔥 V145.0 패치: Rule 59 CS/1399 누락 스캔 강제 지시 추가
                if inspection_mode == "선물세트 박스(외포장) 교차 검토":
                    judgment_prompt = """
