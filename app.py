...
def main():
    ...
    # 🔥 V140.0: 스크롤 가두기 해제 및 100% 강제 노출 인쇄 CSS 완벽 패치
    print_css = """
    <style>
    @media print {
        /* 1. 불필요한 UI 완벽 숨기기 */
    ...
    st.title("🏭 식품 표시사항 정밀 검토 시스템 (V140.0 - 무한 스크롤 보고서 인쇄 완벽 패치)")
...
당신이 출력하는 결과물에 "전략", "중략", "후략", "...", "등" 이라는 요약/생략 단어를 사용하는 순간 이 보고서는 법적 효력을 상실합니다.
환자식 등 원료가 수십 개라도 절대 게으름을 피우지 마십시오. 시안의 '원재료명' 란에 적힌 모든 텍스트를 쉼표(,) 기준으로 완벽하게 분해하여 단 한 개의 원료도 빠짐없이 표의 개별 행(Row)으로 무식할 정도로 전부 나열하십시오. 원료가 50개면 결과 표의 행(Row)도 반드시 50개여야 합니다.
...
|---|---|---|---|
| (무조건 1행 1원료 원칙, 전략/후략 절대 금지, 100% 나열) | [내용 작성] | [내용 작성] | [내용 작성] |
...
|---|---|---|
| (무조건 1행 1원료 원칙, 전략/후략 절대 금지, 100% 나열) | [내용 작성] | [내용 작성] |
