...
- 식약처 「식품등의 표시기준」에 따라, '과일·채소류 음료'뿐만 아니라 **'우유류(가공유 등 유가공품 축산물 포함)'** 등 개봉 후 부패·변질 우려가 높은 제품에는 반드시 **"개봉 후 냉장보관하거나 빨리 드시기 바랍니다"** (또는 이와 유사한 의미의 문구)를 기재해야 합니다. (우유류 면제 아닙, 누락 시 🚨부적합)
...
# 탭별 맞춤형 룰 타겟팅
# ==========================================
TAB1_RULES = [3, 9, 12, 17, 18, 19, 21, 24, 46, 50, 52, 53, 57, 62, 63, 66, 68, 71, 72, 84, 86, 87, 88, 94, 95, 96, 99, 100, 103, 105]
TAB2_RULES = [1, 2, 4, 5, 8, 9, 12, 13, 14, 16, 28, 29, 30, 34, 35, 38, 39, 44, 45, 47, 48, 51, 53, 54, 60, 61, 64, 65, 70, 85, 89, 90, 91, 95, 101]
TAB3_RULES = [3, 6, 10, 11, 23, 24, 25, 26, 27, 31, 32, 33, 40, 41, 55, 68, 79, 80, 82, 83, 97, 98]
TAB4_RULES = [7, 15, 20, 22, 36, 58, 59, 73, 74, 75, 76, 77, 78, 81, 92, 93, 103, 105]
