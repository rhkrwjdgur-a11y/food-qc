...
# 2. 통합 전문가 프롬프트 (Rule 1~43 무삭제 전체 포함 + Rule 35 범용화)
...
---
# [식품 패키지 표시사항 QC 자동화 검수 시스템 룰북 6.7]
...
🔥 **Rule 35. [서류 명칭 일치 및 공전상 간략명 범용 허용 룰 - 최종 강화]**
   ...
   - 지침: 서류와 텍스트가 다르더라도, 해당 시안의 명칭이 공전상 허용된 간략명(예: 카복시메틸셀룰로스나트륨 ➔ CMC, DL-사과산 ➔ 사과산 등)에 해당하는지 범용적으로 판단하여 "법적 간략명 사용으로 적합"함을 명시하십시오.
...
def main():
    ...
    st.title("🏭 식품 표시사항 정밀 검토 (V6.7 - 룰 무삭제 & 범용 간략명 적용)")
    st.markdown("---")
