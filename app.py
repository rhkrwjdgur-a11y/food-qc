...
def main():
    ...
    st.title("🏭 식품 표시사항 정밀 검토 시스템 (V310.7 - 침묵의 픽셀스나이퍼본)")
...
| **영양강조 컷오프(4대 조건)** | [Rule 21, 52] | ⭐[묶어치기 영구 금지]: 여러 영양소(단백질, 칼슘 등) 강조 시 절대 한 줄로 묶지 마십시오. 반드시 [단백질], [칼슘] 등 각각 줄바꿈하여 최소 2개 조건 수식(실측값 및 기준치 대비 %)을 개별 증명할 것. 부적합 시 4개 조건 모두 미달임을 증명! | |
