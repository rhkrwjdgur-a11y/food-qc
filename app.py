...
🔥 **Rule 23. [⭐ 식약처 영양성분별 '0' 표시 절대 규정 및 '불검출' 바(-) 표기 룰 (V340 패치)]**
...
# ⭐ 96번 룰까지 모두 포함
ALL_RULES_NUMBERS = list(range(1, 97))
...
def main():
    ...
    st.title("🏭 식품 표시사항 정밀 검토 시스템 (V341.00 - 다중 업로드 & 범용 족쇄 패치)")
    ...
    with st.sidebar:
        ...
        st.markdown("---")
        # ⭐ V341 패치: 모든 시안 입력란에 accept_multiple_files=True 적용 (테트라팩 등 다중면 대응)
