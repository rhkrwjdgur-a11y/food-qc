...
# ==========================================
# 📚 3. 89대 마스터 룰북 원문 (V311.45 완결본 - 내용량 대조 및 무첨가 레이아웃 유연성 패치)
# ==========================================
RULE_BOOK_FULL = """
...
def main():
    ...
    st.title("🏭 식품 표시사항 정밀 검토 시스템 (V311.45 - 내용량 예외 및 무첨가 레이아웃 패치)")
