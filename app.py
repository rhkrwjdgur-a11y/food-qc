...
# ==========================================
# 📚 3. 63대 룰북 원문 (V155.0 완결판 - 영양강조 미달 성분 N종 카운트 제외 패치)
# ==========================================
RULE_BOOK_FULL = """
...
🔥 **Rule 24. [무당/무가당 2대 의무 표기 조건 (감미료 & 열량 강제 병기)]**
   ...
   - 1) **[⭐ 감미료 표기 강제 및 위치 검증]**: 감미료가 들어갔다면 "감미료 함유" 문구는 무조건 "가장 큰 폰트로 적힌 강조표시 주위"에 기재되어야 합법.
   - 2) **[⭐ 저열량 미충족 시 열량 강제 병기]**: 제품 자체가 '저열량' 법적 기준을 충족하지 못하는 경우, 반드시 강조표시 주위에 총 내용량에 해당하는 열량을 표시해야 합니다.
...
def main():
    ...
    st.title("🏭 식품 표시사항 정밀 검토 시스템 (V155.0 - 영양강조 미달 성분 N종 카운트 제외 패치)")
...
- ⭐ [Rule 52] 마케팅 숫자(N종, N곡 등) 정합성 및 영양강조 기준(15% 또는 7.5%) 미달 성분 N종 카운트 포함 여부 강제 스캔:
- 기타 특이사항:
...
- ⭐ [Rule 52] 마케팅 숫자(N종, 소수점 등) 정합성 및 영양강조 기준(15% 또는 7.5%) 미달 성분 N종 카운트 포함 여부 강제 스캔:
