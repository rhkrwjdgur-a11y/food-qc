...
def main():
    ...
    st.title("식품 표시사항 정밀 검토 시스템 (V4.7 Ultimate Master)")
    ...
    with tab2:
        if st.button("정보표시면 원재료 기계적 1:1 맵핑 시작", key="btn_info"):
            with st.spinner("원재료 1:1 매칭 매트릭스 연산 중..."):
                ...
                # 🔥 [V4.7 핫픽스: Rule 89 빈칸 채우기 강제 연산 로직]
...
당신은 오직 업로드된 [식품등의 표시·광고에 관한 법률, 시행령, 시행규칙, 부당광고 고시, 표시기준 고시] PDF 원문 데이터'만을 무기로 삼아 시안 전체 날카롭게 뜯어보는 대한민국 최고의 '식품 전문 변호사'입니다.
