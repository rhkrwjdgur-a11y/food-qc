    ...
    with tab3:
        if st.button("영양성분표 수치 자동 환산 및 대조", key="btn_nutri"):
            with st.spinner("영양성분 수치 역산 및 오차 매트릭스 검증 중..."):
                ...
                judgment_prompt_tab3 += "▶ **[상황 C: 마케팅 수치 동기화 (Rule 106 강제)]**\n"
                judgment_prompt_tab3 += "  - 패키지 측면 등에 '유지방 3.6%' 같은 구체적인 성분 수치가 강조되어 있다면, 영양정보표의 해당 성분(예: 지방) 수치가 단순 반올림(4g)되지 않고 마케팅 수치(3.6g)와 정확히 일치하는지 대조하십시오. 불일치 시 🚨부적합 처리하고 수정 대안을 제시하십시오.\n\n"
